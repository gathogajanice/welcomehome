...
const Footer = () => {
  return (
    <div className="min-h-screen bg-[#387f79] relative overflow-hidden">
      {/* Background Image */}
      <div 
      ...
      ></div>
      <div className="px-4 py-8 sm:py-16 relative">
        <div className="container mx-auto border border-[#fffbf0] rounded-2xl p-4 sm:p-6 md:p-8 bg-[#387f79] relative z-10">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-6 lg:gap-8">
            ...
            <div className="space-y-6">
              <div className="text-left">
                <div className="backdrop-blur-lg bg-white/10 border border-[#fffbf0] shadow-2xl rounded-xl px-6 py-4 md:px-8 md:py-6 inline-block min-h-[80px] w-full max-w-[420px] flex flex-col justify-center items-start text-left" style={{boxShadow: '0 8px 32px 0 rgba(31, 38, 135, 0.15)'}}>
                  <h2 className="font-troye text-lg md:text-2xl text-[#fffbf0] mb-1 leading-tight whitespace-nowrap text-left">
                    Welcome Home
                  </h2>
                  <span className="font-bd-sans text-sm md:text-lg text-[#fffbf0] tracking-wider uppercase block leading-tight text-left">
                    Africa's Real Estate Revolution
                  </span>
                </div>
              </div>
              {/* Social Media Links */}
              <div className="flex space-x-4 mt-6">
                {['facebook', 'twitter', 'linkedin', 'instagram'].map((platform, index) => (
                  <motion.a 
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="social-icon-container w-11 h-11 rounded-full bg-white/10 border border-[#fffbf0] flex items-center justify-center relative overflow-hidden backdrop-blur-lg shadow-xl transition-all duration-300"
                    style={{boxShadow: '0 4px 24px 0 rgba(31, 38, 135, 0.10)'}}
                  >
                    {platform === 'twitter' ? (
                      <svg 
                        viewBox="0 0 24 24"
                        className="w-5 h-5 text-[#fffbf0] z-10"
                        fill="currentColor"
                      >
                      ...
                      <Facebook size={20} className="social-icon text-[#fffbf0]" />
                    ) : platform === 'linkedin' ? (
                      <Linkedin size={20} className="social-icon text-[#fffbf0]" />
                    ) : (
                      <Instagram size={20} className="social-icon text-[#fffbf0]" />
                    )}
                  </motion.a>
                ))}
              </div>
            ...
            <div className="text-left space-y-3">
              <h3 className="font-bd-sans text-lg text-[#fffbf0] mb-4">Quick Links</h3>
            ...
            <div className="text-left space-y-6">
              <div className="space-y-4">
                ...
                <div className="flex flex-col items-start mt-4">
                  <h2 className="font-troye text-lg text-[#fffbf0]">
                    Own a piece of the future.
                  </h2>
                  <p className="font-bd-sans text-xs uppercase text-[#fffbf0] mt-2 tracking-wider">
                    EMPOWERING THE DIASPORA, BUILDING LEGACY.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mt-12">
            <div className="relative z-10 w-full flex flex-col items-center justify-center">
              <h1 className="font-troye text-3xl md:text-6xl lg:text-7xl text-[#cbe9e9] text-center leading-none mb-2">WELCOME HOME</h1>
