    ...
    <div className="relative w-full h-[100svh] overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-end pb-28 md:pb-36 justify-center z-40 px-6">
        <div className="flex flex-col items-center justify-center space-y-2">
          <h1 className="font-['Troye Sans'] text-4xl sm:text-6xl md:text-7xl lg:text-8xl text-[#fffbf0] leading-tight tracking-wide font-bold">
            WELCOME<br />HOME
          </h1>
          ...
          <p className="font-['Beautifully Delicious'] text-lg sm:text-xl md:text-2xl text-[#fffbf0] tracking-wide">
            SENEGAL | GHANA | KENYA
          </p>
          ...
          <motion.button 
            className="mt-4 px-6 py-2 border border-[#cbe9e9] rounded-xl 
                     ...
                     text-[#fffbf0] font-['Beautifully Delicious'] tracking-wider text-sm
