  ...
  return <section className="min-h-screen bg-[#f8f6f2] px-4 py-16">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="relative">
          ...
          {hotspots.map(hotspot => <div key={hotspot.id} className="absolute h-6 w-6 rounded-full bg-black opacity-70 
                         hover:scale-110 transition-transform duration-300
                         [animation:ripple_2s_ease-in-out_infinite]" style={{
        ...
        <div className="space-y-8 text-left">
          <div className="space-y-4">
            <h1 className="text-4xl md:text-5xl font-bold font-bricolage">
              <span className="text-5xl font-medium text-black">Why Invest in Real Estate in </span>
