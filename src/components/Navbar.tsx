  ...
  return (
    <>
      <style jsx>{`
        ...
        .sleek-hover-container:active::before {
          transform: scaleX(1);
        }
      ...
      >
        ...
        <div className="flex items-center space-x-6">
          {/* Phone Number */}
          <div className="hidden md:flex items-center sleek-hover-container px-3 py-1 rounded-md">
            <span className="text-black text-xs font-light relative z-10">+254 710293233</span>
            <span className="text-black mx-2 font-light relative z-10">/</span>
          ...
          <div className="hidden md:flex items-center">
            <a 
              href="#" 
              className="sleek-hover-container bg-cream text-black text-xs tracking-[0.075em] font-light uppercase px-4 py-1.5 rounded-md"
            >
